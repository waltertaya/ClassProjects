...
_lr_productions = [
  ...
  ('statement_list -> statement','statement_list',1,'p_statement_list','zara_parser_with_translation.py',23),
  ('statement_list -> statement_list statement','statement_list',2,'p_statement_list','zara_parser_with_translation.py',24),
  ('statement -> expression_statement','statement',1,'p_statement','zara_parser_with_translation.py',31),
  ('statement -> conditional_statement','statement',1,'p_statement','zara_parser_with_translation.py',32),
  ('statement -> loop_statement','statement',1,'p_statement','zara_parser_with_translation.py',33),
  ('expression_statement -> ID ASSIGN expression','expression_statement',3,'p_expression_statement','zara_parser_with_translation.py',37),
  ('expression -> expression PLUS term','expression',3,'p_expression','zara_parser_with_translation.py',44),
  ('expression -> expression MINUS term','expression',3,'p_expression','zara_parser_with_translation.py',45),
  ('expression -> term','expression',1,'p_expression_term','zara_parser_with_translation.py',53),
  ('term -> term TIMES factor','term',3,'p_term','zara_parser_with_translation.py',57),
  ('term -> term DIVIDE factor','term',3,'p_term','zara_parser_with_translation.py',58),
  ('term -> factor','term',1,'p_term_factor','zara_parser_with_translation.py',66),
  ('factor -> NUMBER','factor',1,'p_factor_number','zara_parser_with_translation.py',70),
  ('factor -> ID','factor',1,'p_factor_id','zara_parser_with_translation.py',74),
  ('conditional_statement -> IF expression statement ELSE statement','conditional_statement',5,'p_conditional_statement','zara_parser_with_translation.py',78),
  ('conditional_statement -> IF expression statement','conditional_statement',3,'p_conditional_statement','zara_parser_with_translation.py',79),
  ('loop_statement -> WHILE expression statement','loop_statement',3,'p_loop_statement','zara_parser_with_translation.py',93),
]
